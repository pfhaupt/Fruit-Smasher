...
class ChestMenu extends MenuTemplate {
  constructor(name, x, y, w, h, col) {
    ...
    this.children.push(new Button("Open", 0.55, 0.15, 0.2, 0.1, () => {
      player.openChests(0);
    }));
    this.children.push(new Button("Open", 0.55, 0.25, 0.2, 0.1, () => {
      player.openChests(1);
    }));
    this.children.push(new Button("Open", 0.75, 0.35, 0.2, 0.1, () => {
      player.openChests(2);
    }));
    this.children.push(new Button("Open", 0.75, 0.45, 0.2, 0.1, () => {
      player.openChests(3);
    }));
  }
