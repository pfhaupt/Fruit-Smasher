class FieldMenu extends MenuTemplate {
  constructor(name, x, y, w, h, col) {
    ...
    this.children.push(new Text("Zone: ", "currentZone", 0.4, 0.7, 0.2, 0.1, 30));
    ...
    this.children.push(new Text("Enemy Lvl: ", "enemy.level", 0.65, 0.47, 0.3, 0.03));
    ...
    //Anzeige Spieler
    this.children.push(new Text("Player Lvl: ", "player.level", 0.05, 0.47, 0.3, 0.03));
